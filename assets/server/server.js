const fs = new Object;
// import {VideoDataManager} from "./video_data_manager.js";
...
Server.prototype.getRandomPortrait = function() {
    return "./pages/img/chars/" + this.getRandomCharId() + ".png";
};
...
//         res.send( this.templateManager.renderTemplate(
//             "index.html", { search : searchResult } ) );
//     } );
...
//         res.send( this.templateManager.renderTemplate(
//             "editor.html",
//             { auth, canApprove : this.approveCheck( auth, req ) } ) );
//     } );
...
//                 this.logger.log( "Approved provisional video: " +
//                 req.body.vid,
//                                  ip, auth );
//                 res.sendStatus( 200 );
//             } else {
...
//                 this.videoDataManager.saveData( this.games );
//                 this.logger.log( "Deleted provisional video: " +
//                 req.body.vid,
//                                  ip, auth );
//                 res.sendStatus( 200 );
//             } else {
...
//         let ip = req.connection.remoteAddress;
//         let error =
//             this.matchManager.addMatch( req.body, ip, this.authCheck( req )
//             );
//         if ( error ) {
...
//         let ip = req.connection.remoteAddress;
//         let error =
//             this.matchManager.editMatch( req.body, ip, this.authCheck( req )
//             );
//         if ( error ) {
//             res.status( 400 ).send( error );
//         } else {
...
//         let ip = req.connection.remoteAddress;
//         let error =
//             this.matchManager.editVideo( req.body, ip, this.authCheck( req )
//             );
//         if ( error ) {
//             res.status( 400 ).send( error );
//         } else {
...
//         let ip = req.connection.remoteAddress;
//         let error = this.matchManager.deleteMatch( req.body, ip,
//                                                    this.authCheck( req ) );
//         if ( error ) {
//             res.status( 400 ).send( error );
//         } else {
...
//         } else {
//             let json = {
//                 html : this.templateManager.renderTemplate(
//                     "editorVideoMatches.html", { vid } ),
...
//             charPlayers : this.templateManager.renderTemplate(
//                 "characterPlayerStatistics.html", { char : req.query.char } )
//         } );
//     } );
// };
